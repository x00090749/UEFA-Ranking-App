		...
		protected Void doInBackground(Void... arg0) {
			...
			if (jsonStr != null) {
				try {
					...
					countries = jsonObj.getJSONArray(TAG_COUNTRIES);
					...
					for (int i = 0; i < countries.length(); i++) {
						...
						String CountryName = c.getString(TAG_COUNTRYNAME);
						String CountryCode = c.getString(TAG_COUNTRYCODE); //email
						String Position = c.getString(TAG_POSITION); //address
