...
public class TeamRankingActivity extends ListActivity
{
    ...
    //URL to get Teams
    private static String url = "http://uefaservicev9.azurewebsites.net/api/teamrankingsapi";
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter
                    (
                        ...
                        teamRankingList,
                        R.layout.list_round_one,
                        new String[] { TAG_ID, TAG_TEAMNAME, TAG_COUNTRYCODE, TAG_RANKING },
                            new int[] { R.id.Id, R.id.TeamName,R.id.CountryCode, R.id.Ranking }
                    );
