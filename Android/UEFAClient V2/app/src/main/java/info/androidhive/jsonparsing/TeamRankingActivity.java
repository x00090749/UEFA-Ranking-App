...
public class TeamRankingActivity extends ListActivity
{
    ...
    //URL to get Teams
    private static String url = "http://uefaservicev4.azurewebsites.net/api/teamrankings/";
    ...
    private class GetTeamRankings extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    TeamRankingActivity.this, teamRankingList,
                    R.layout.list_item, new String[] { TAG_TEAMNAME, TAG_COUNTRYCODE,
                    TAG_RANKING }, new int[] { R.id.TeamName,
