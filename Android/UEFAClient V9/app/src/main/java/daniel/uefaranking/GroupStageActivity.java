...
public class GroupStageActivity extends ListActivity {
    private ProgressDialog pDialog;

    private static String url = "https://uefaservicev9.azurewebsites.net/api/groupstagesapi/";
    //JSON Node Names
    ...
    //Team Position Order
    private static int[] teamPosition = new int[32];
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                in.putExtra(TAG_TEAMNAME, TeamName); //Team Name
    ...
    private class GetTeams extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(GroupStageActivity.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < teams.length(); i++) {
                        ...
                        String Id = "Position: " + teamPosition[i]; //Position
                        ...
                        // adding selected Team to Team list
                        teamsList.add(team);
                    }
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    GroupStageActivity.this, teamsList,
