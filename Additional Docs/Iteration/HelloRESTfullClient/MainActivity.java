...
{ 
    ...
    //private static String SERVICE_URL = "http://prototypeuefa.azurewebsites.net/api/Hello";
	private static String SERVICE_URL = "http://prototypenewest.azurewebsites.net/api/Teams";
