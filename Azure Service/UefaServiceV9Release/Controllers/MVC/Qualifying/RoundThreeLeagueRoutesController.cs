...
namespace UefaServiceV9.Controllers.MVC.Qualifying
{
    public class RoundThreeLeagueRoutesController : Controller
    {
        ...
        {
            return View(db.RoundThreeLeagueRoutes.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "Id,TeamName,CountryCode,Ranking,TeamRankingId")] RoundThreeLeagueRoute roundThreeLeagueRoute)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TeamName,CountryCode,Ranking,TeamRankingId")] RoundThreeLeagueRoute roundThreeLeagueRoute)
        {
            if (ModelState.IsValid)
            {
